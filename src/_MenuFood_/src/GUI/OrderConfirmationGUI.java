...
public class OrderConfirmationGUI extends javax.swing.JFrame {
    ...
    Stack<Dish> deletedDishes = new Stack<Dish>();
    ...
    private void initComponents() {
        ...
        button_delete.setBackground(new java.awt.Color(255, 243, 224));
        button_delete.setForeground(new java.awt.Color(255, 243, 224));
        button_delete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/src/deleteicon.png"))); // NOI18N
        button_delete.setPreferredSize(new java.awt.Dimension(25, 25));
        ...
        button_undo.setBackground(new java.awt.Color(255, 243, 224));
        button_undo.setForeground(new java.awt.Color(255, 243, 224));
        button_undo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/src/undoicon.png"))); // NOI18N
        button_undo.setPreferredSize(new java.awt.Dimension(25, 25));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(button_undo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void button_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_deleteActionPerformed
        ...
        if (model.getSize() == 1) {
            JOptionPane.showMessageDialog(rootPane, "No puedes Eliminar mas platos!", "Error al eliminar del carrito!", JOptionPane.OK_OPTION);
        } else {

            Dish sdish;

            try {
                int index = list_order.getSelectedIndex();
                sdish = (Dish) model.getElementAt(index);
                LinkedList<Dish> orderedDishes = this.ord.getDishes();
                orderedDishes.deleteNode(sdish);

                //Guardar el plato eliminado por si se quiere deshacer
                deletedDishes.push(sdish);
                this.ord.setDishes(orderedDishes);
                loadOrder(this.ord);

            } catch (Exception e) {
                System.out.println(e);
                JOptionPane.showMessageDialog(rootPane, "Porfavor selecciona un plato para eliminar", "Error al eliminar del carrito!", JOptionPane.OK_OPTION);
            }
        }
    ...
    private void button_undoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_undoActionPerformed
        ...
        if (deletedDishes.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Aun no has eliminado ningun plato recientemente", "Error al rehacer!", JOptionPane.OK_OPTION);
        } else {
            
            LinkedList<Dish> orderedDishes = this.ord.getDishes();
            tempdish = deletedDishes.pop();
            orderedDishes.pushBack(tempdish);
            this.ord.setDishes(orderedDishes);
            model.clear();
            loadOrder(this.ord);
